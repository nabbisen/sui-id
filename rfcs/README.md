...
slot is `104`). One **parallel namespace** also exists:
...
scope and prerequisites. **That return closed on 2026-08-27**: each was reviewed
by the implementation role, which authored none of them, and re-accepted by
