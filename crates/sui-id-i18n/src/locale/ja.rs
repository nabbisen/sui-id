...
pub static STRINGS_JA: Strings = Strings {
    ...
    factor_add_password_label: "現在のパスワード",
    factor_add_password_hint: "最初の 2 要素目を追加するには、現在のパスワードを入力してください。",
    factor_add_reauth_failed: "本人確認ができませんでした。パスワードを確認して、もう一度お試しください。",
    factor_add_reauth_unavailable: "現在、ディレクトリでパスワードを確認できません。しばらくしてからお試しください。",
    factor_add_federated_unavailable: "外部の ID プロバイダーでサインインするアカウントは、ここではまだ 2 要素目を追加できません。",
    ...
    reset_done_title: "パスワードを設定しました",
    reset_done_lede: "新しいパスワードでサインインできます。このアカウントの他のセッションはすべてサインアウトされました。",
    reset_done_lockout_cleared: "このアカウントは、繰り返しの失敗によりサインインが拒否されていました。その制限は解除されました。",
    reset_done_lockout_watch: "しばらくしてもう一度拒否される場合は、誰かがあなたのアカウントのパスワードを試している可能性があります。数分待ってからもう一度お試しください。",
    reset_done_second_factor_before: "二要素認証を伴うサインインは、",
    reset_done_second_factor_after: " まで一時停止されています。このリセットではその停止は解除されません。",
    ...
    copy_noun_recovery_link: "復旧リンク",
    copy_noun_recovery_token: "復旧トークン",
    confirm_recovery_link_title: "アカウント復旧リンクを発行しますか？",
    confirm_recovery_link_impact: "一度だけ使える、有効期間 30 分のリンクが作成されます。ユーザーはこのリンクを開いて自分でパスワードを決めます。あなたがパスワードを見たり設定したりすることはありません。このユーザーの以前のリンクは無効になります。第二要素が設定されている場合、サインイン時には引き続き必要です。",
    confirm_recovery_link_reversibility: "リンクは、渡した後に取り消すことはできません。別のリンクを発行するか、ユーザーを無効化すると、このリンクは使えなくなります。",
    confirm_recovery_link_button: "復旧リンクを発行",
    recovery_link_handover: "リンクは、本人であることを確認できる手段で渡してください。たとえば、登録済みの番号への折り返し電話や、直接の手渡しです。依頼と同時に相手が示したアドレスや番号には送らないでください。有効期間は 30 分なので、すぐに渡してください。",
    recovery_reason_label: "理由（必須）",
    recovery_reason_placeholder: "例：登録済みの番号への折り返しで本人確認、チケット 4711",
    recovery_reason_hint: "監査ログに記録されます。1 行で、200 文字以内。",
    recovery_link_issued_title: "復旧リンクを発行しました",
    recovery_link_issued_once: "リンクが表示されるのはこの 1 回だけです。今すぐコピーしてください。このページを離れると再表示できません。",
    recovery_link_url_label: "リンク",
    recovery_link_url_aria: "復旧リンク",
    recovery_link_token_label: "トークン",
    recovery_link_token_hint: "メールやチャットのアプリがリンクの # 以降（フラグメント）を削除した場合は、リセット画面にこのトークンを貼り付けてもらってください。",
    recovery_link_token_aria: "復旧トークン",
    recovery_link_expires_label: "有効期限",
    recovery_link_invalidated_label: "無効にした以前のリンク",
    recovery_link_back: "ユーザーに戻る",
    recovery_refused_title: "復旧リンクを発行しませんでした",
    recovery_refused_unchanged: "何も変更されていません。",
    recovery_refused_reason_required: "理由の入力が必要です。",
    recovery_refused_reason_too_long: "理由が長すぎます。200 文字以内、かつ 512 バイト以内にしてください。",
    recovery_refused_reason_control: "理由に改行やタブなどの制御文字を含めることはできません。",
    recovery_refused_target_unknown: "そのユーザーは存在しません。",
    recovery_refused_target_self: "自分自身の復旧リンクは発行できません。セキュリティ設定でパスワードを変更するか、パスワードをお忘れの場合のページを使ってください。",
    recovery_refused_target_admin: "管理者アカウントは管理画面から復旧できません。ホスト上で運用担当者に sui-id admin issue-recovery-link を実行してもらってください。",
    recovery_refused_target_non_local: "このアカウントはディレクトリまたは外部プロバイダー経由でサインインするため、パスワードはここでは管理されません。",
    recovery_refused_target_disabled: "このユーザーは無効化されています。先にアカウントを有効化してください。",
    recovery_refused_target_deleted: "このユーザーは削除されています。",
    recovery_refused_throttled: "1 時間に発行できる復旧リンクの上限に達しました。しばらくしてからもう一度お試しください。",
    recovery_refused_needs_second_factor: "復旧リンクを発行するには、あなた自身に第二要素（認証アプリまたはパスキー）が設定されている必要があります。セキュリティ設定で設定してから、もう一度お試しください。",
};
