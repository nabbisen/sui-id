...
pub struct Strings {
    ...
    pub copy_noun_recovery_link: &'static str,
    pub copy_noun_recovery_token: &'static str,
    pub confirm_recovery_link_title: &'static str,
    pub confirm_recovery_link_impact: &'static str,
    pub confirm_recovery_link_reversibility: &'static str,
    pub confirm_recovery_link_button: &'static str,
    pub recovery_link_handover: &'static str,
    pub recovery_reason_label: &'static str,
    pub recovery_reason_placeholder: &'static str,
    pub recovery_reason_hint: &'static str,
    pub recovery_link_issued_title: &'static str,
    pub recovery_link_issued_once: &'static str,
    pub recovery_link_url_label: &'static str,
    pub recovery_link_url_aria: &'static str,
    pub recovery_link_token_label: &'static str,
    pub recovery_link_token_hint: &'static str,
    pub recovery_link_token_aria: &'static str,
    pub recovery_link_expires_label: &'static str,
    pub recovery_link_invalidated_label: &'static str,
    pub recovery_link_back: &'static str,
    pub recovery_refused_title: &'static str,
    pub recovery_refused_unchanged: &'static str,
    pub recovery_refused_reason_required: &'static str,
    pub recovery_refused_reason_too_long: &'static str,
    pub recovery_refused_reason_control: &'static str,
    pub recovery_refused_target_unknown: &'static str,
    pub recovery_refused_target_self: &'static str,
    pub recovery_refused_target_admin: &'static str,
    pub recovery_refused_target_non_local: &'static str,
    pub recovery_refused_target_disabled: &'static str,
    pub recovery_refused_target_deleted: &'static str,
    pub recovery_refused_throttled: &'static str,
    pub recovery_refused_needs_second_factor: &'static str,
